export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 flex-shrink-0 fill-purple-400 dark:fill-purple-300",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 flex-shrink-0 fill-neutral-700 hs-tab-active:fill-purple-400 dark:fill-neutral-300 dark:hs-tab-active:fill-purple-300 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 flex-shrink-0 text-neutral-700 hs-tab-active:fill-purple-400 dark:fill-neutral-300 dark:hs-tab-active:fill-purple-300 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  mapPinColored: {
    ...
    class:
      "mt-1.5 h-6 w-6 flex-shrink-0 hs-tab-active:text-purple-400 dark:text-neutral-300 dark:hs-tab-active:text-purple-300",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
  ...
  hammer: {
    ...
    class:
      "mt-1 size-5 flex-shrink-0 hs-tab-active:fill-purple-400 dark:fill-neutral-300 dark:hs-tab-active:fill-purple-300",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
  ...
  sparks: {
    ...
    class:
      "mt-1 size-5 flex-shrink-0 hs-tab-active:text-purple-400 dark:text-neutral-300 dark:hs-tab-active:text-purple-300",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
